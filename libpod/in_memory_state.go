...
// GetAllContainers retrieves all containers from the state
...
// GetPod retrieves a pod from the state from its full ID
...
// GetAllPods retrieves all pods currently in the state
